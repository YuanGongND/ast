...
Nov, 2021: The PSLA training pipeline and baseline efficientnet model code is released [here](https://github.com/YuanGongND/psla). It is a strong audio classification training pipeline that can be used for most deep learning models. Also, it has a one-click FSD50K recipe that achieves SOTA 0.567 mAP.
